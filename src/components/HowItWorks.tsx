...
export default function HowItWorks() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. All digital tools purchased on Official Tool Store come with a full active replacement warranty. If you encounter any access blocks or technical issues during your package duration, we will instantly replace the credentials.",
    },
  ];
